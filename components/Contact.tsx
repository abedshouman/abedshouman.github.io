    ...
    <section id="contact" className="mx-auto max-w-3xl px-6 py-28 text-center">
      ...
      <div className="mx-auto mt-8 flex max-w-md flex-col gap-3 sm:flex-row sm:justify-center">
        <a
          ...
          className="group flex items-center justify-center gap-2 rounded-lg border border-accent px-6 py-4 font-medium text-accent transition hover:bg-accent hover:text-white"
        >
